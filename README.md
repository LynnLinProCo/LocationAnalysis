...
## 5. Considerations
The current study serve as exploratory analysis. Thus, weakness of the model is ignored to priortize estimating performance instead of optimizing the model. 
